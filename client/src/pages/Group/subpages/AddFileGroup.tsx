...
function AddFile() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formData.append("storageType", "group");
  ...
  return (
    ...
    >
      ...
      <div
        className={`
				w-[30%] h-fit ${error ? "shadow-red-300" : "border border-border"} flex
      ...
      >
        <form onSubmit={handleSubmit}>
          <div>
            <p className="font-medium text-[20px] text-primary">Upload File</p>
            <p className="font-extralight text-sm">Upload files to group</p>
          </div>
          ...
          <input
            ...
            type="file"
            multiple
            className="hover:font-bold mb-10 mt-10"
          />
