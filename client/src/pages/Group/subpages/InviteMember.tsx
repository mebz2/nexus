...
function InviteMember() {
	return (
		...
		>
			...
			<Link to={"/group/members"} className="
			...
			">
				...
				<div className="p-3 bg-green-200 rounded-lg flex flex-col gap-3">
					...
					<p className="text-sm font-medium text-[#075800]">
						They’ll receive an invitation in their nexus inbox with a button to accept or reject
						the invitation. If they accept, they’ll have access the group.
					</p>
				</div>

				<div className="h-9 w-50 mx-auto">
					<Button label="Send Invite" radius={5} onClick={() => { console.log("Create group") }} />
				</div>
			</div>
