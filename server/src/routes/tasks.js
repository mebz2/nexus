...
router.get('/groups/:groupId/tasks', (req, res) => {
	res.send(`Get all tasks for group ${req.params.groupId} route`);
});
...
router.post('/groups/:groupId/tasks', (req, res) => {
	res.send(`Create new task in group ${req.params.groupId} route`);
});
...
router.put('/tasks/:taskId', (req, res) => {
	res.send(`Update task ${req.params.taskId} route`);
});
...
router.delete('/tasks/:taskId', (req, res) => {
	res.send(`Delete task ${req.params.taskId} route`);
});
